...
export const Header = () => {
  ...
  return (
    <div className={`  w-full   flex  md:justify-between flex-wrap flex-col md:flex-row z-50  ${user ? 'pt-3  md:px-14 absolute' : 'p-6 w-9/12 m-auto'}`}>
      <Link to="/browse">
        <img className="-mt-2 w-40 m-auto  h-15 md:w-50  h-20" src="https://res.cloudinary.com/dl4rdt9w0/image/upload/t_gptflix_trnf/GptFlix/qjf7w3ofez7u1oktt42i" alt="logo-gptflix" />
      </Link>
      {/* <Link to="/browse"><svg
        viewBox="0 0 111 30"
        version="1.1"
