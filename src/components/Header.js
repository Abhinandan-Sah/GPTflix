  ...
  return (
    <div className={`  w-full   flex justify-between z-50  ${user ? 'pt-3 px-16 absolute' : 'p-6 w-9/12 m-auto'}`}>
      <svg
        ...
        aria-hidden="true"
        role="img"
        className="default-ltr-cache-1d568uk ev1dnif2 w-40 h-20"
      >
        <g fill="red">
      ...
      {user && (
        <div className="flex items-center gap-2 text-slate-100">
          <button onClick={handleGptSearch} className="p-2 px-4 mx-4 bg-orange-500  text-white rounded-lg">GPT Search</button>
          <img
